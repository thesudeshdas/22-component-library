...
export default function Alert() {
  ...
  return (
    <main className='page'>
      ...
      <h2 className='font-semi-bold spc-vt-md'>Basic Alert</h2>
      ...
      <section className='component__container component__container--alert spc-vt-lg padding-md'>
      ...
      <h2 className='font-semi-bold spc-vt-md'>Outline Alert</h2>
      <p className='spc-vt-md'>
      ...
      <h2 className='font-semi-bold spc-vt-md'>Alert with Close Button</h2>
      <p className='spc-vt-md'>
      ...
      <section className='component__container component__container--alert spc-vt-lg padding-md'>
        <div className='alert alert--primary flex-horizontal flex-align-center'>
          ...
          <button className='button button-icon alert-close flex-center'>
            <IcRoundClose className='font-lg' />
          </button>
        </div>
        <div className='alert alert--success flex-horizontal flex-align-center'>
          <strong>Success!</strong> This is a success alert. Check it out!
